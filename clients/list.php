      ...
      <div class="card">
        ...
        <div class="card-body p-0">
          <table class="table table-striped projects">
              ...
              <tbody>
              <?php if (isset($clients) && $clients->num_rows > 0) {
                  ...
                  <tr>
                      ...
                      <td class="project-actions text-right">
                          <a class="btn btn-primary btn-sm" href="view.php?client_id=<?php echo $id;?>">
                              <i class="fas fa-folder">
                              </i>
                              View
                          </a>
                          <a class="btn btn-info btn-sm" href="edit.php?client_id=<?php echo $id;?>">
                              <i class="fas fa-pencil-alt">
                              </i>
                              Edit
                          </a>
                          <a class="btn btn-danger btn-sm" onclick="return confirm('Are you sure?')" href="delete.php?client_id=<?php echo $id;?>">
